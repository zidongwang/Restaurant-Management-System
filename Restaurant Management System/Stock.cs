...
namespace Restaurant_Management_System
{
    public partial class StockClass : Form
    {
        ...
        private void InitialGrid()
        {
            ...
            {
                 ds = MySQLConnection.GetDataSetValue("select * from stock", "tb");    
            }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    DataSet ds = MySQLConnection.GetDataSetValue(sql,"tb");
        ...
        private void deleteData(int id)
        {
            try
            {
                ...
                MySqlConnection MySqlCon1 = new MySqlConnection(MySQLConnection.SqlCon);
                MySqlCon1.Open();
